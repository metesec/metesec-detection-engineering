  ...
  assert.deepEqual(
    ...
    [
      ...
      },
      {
        ...
        detections: ["MSEC-DET-0040", "MSEC-DET-0046", "MSEC-DET-0047"],
        required_columns: 14,
      },
    ],
  );
